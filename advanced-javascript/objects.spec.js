...
describe('mapObject', () => {
	test('should map the the keys to the new object', () => {
...
describe('pairs', () => {
	test('should return correct object pairs put into arrays', () => {
...
describe('invert', () => {
	test('should switch the keys and values on the object', () => {
